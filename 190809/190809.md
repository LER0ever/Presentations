...
### 2. Data Parallelism {.text-shadow .animated.fadeInUp}  
### 3. Model Parallelism {.text-shadow .animated.fadeInUp}  
### 4. Pipelining {.text-shadow .animated.fadeInUp}  
...
<slide class="fullscreen bg-blue" :class="aligncenter">
...
## Thank You {.animated.tada}

#### References

[1]: Dean, Jeffrey, et al. “Large scale distributed deep networks.”{.alignleft}  
[2]: Saliya Ekanayake. “Model Parallelism in Deep Learning is NOT What You Think”{.alignleft}  

[:fa-github: Source code of this presentation](https://github.com/ksky521/nodeppt){.button.animated.delay-1s.fadeInUp}
